...
import inmobiliaria.Validacion;
...
public class VerDetalleInmueble2 extends JFrame implements Validacion{
	 ...
	 * Create the frame.
	 */
	public VerDetalleInmueble2(int idInmueble, Inmueble inmueble) {
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				VerInmueblesDisponibles2 volver = new VerInmueblesDisponibles2();
				dispose();
			}
		});
