...
public class ActivarInmuebles extends JFrame {
	...
	public ActivarInmuebles() {
        ...
        JButton btnActivar = new JButton("Activar Inmueble");
        btnActivar.setForeground(Color.WHITE);
        btnActivar.setFont(new Font("Tahoma", Font.BOLD, 12));
        btnActivar.setBorder(null);
        btnActivar.setBackground(new Color(48, 109, 105));
        btnActivar.setBounds(1134, 570, 150, 34);
        ...
        btnActivar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow == -1) {
                    JOptionPane.showMessageDialog(null, "Por favor, seleccione un inmueble para activar.");
                    return;
                }
                ...
                controlador.updateInmueble(inmueble);
                
                JOptionPane.showMessageDialog(null, "Inmueble activado correctamente.");
